...
//communication
const String HMIScript[HMI_SCRIPT_NUM] = { "a.val=", "b.val=", "u.txt=", "c.val=", "d.val=", "e.val=", "v.txt=",
                                           "f.val=", "g.val=", "h.val=", "i.val=",
                                           "j.val=", "k.val=", "l.val=", "m.val=", "n.val=",
                                           "o.val=", "p.val=", "q.txt=", "r.txt=", "s.txt=", "t.txt="
                                         };
const int HMIMap[HMI_SCRIPT_NUM] = {SPEED, REVERSER, NEXT_STATION_DIS, POWER, BRAKE, SIGNAL_INFO, CURRENT_TIME,
                                    SIGNAL_DISTANCE, SPEED_LIMIT, HORN, MASTER_KEY, LDOOR_OPEN, LDDOR_IN_OP, RDOOR_OPEN, RDOOR_IN_OP,
