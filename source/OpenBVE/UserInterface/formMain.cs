...
namespace OpenBve {
	...
	#pragma warning restore 0219
		...
		private void buttonCCP_Click(object sender, EventArgs e)
		{
		...
		private void labelFillerTwo_Click(object sender, EventArgs e)
		{
			const string Url = "http://github.com/tsdarthur";
			try
			{
				System.Diagnostics.Process.Start(Url);
			}
